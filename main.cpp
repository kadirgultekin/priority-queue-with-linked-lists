...
// ------------------------------------------------------------------------------
// Kadir GULTEKIN
// Three sample test scenarios are implemented
// ------------------------------------------------------------------------------
...
cout << "number of elements in the queue after one insertion is:" << MyPQ->PQLength() << endl; // length: 4
cout << "what is at the front?: " << (MyPQ->PQFront()).ShowData() << endl; // front: f
MyPQ->PQClear(); // queue:
MyPQ->ShowPQ();
MyPQ->PQInsert(*MyElement3); // queue: g
MyPQ->PQInsert(*MyElement1); // queue: eg
cout << "number of elements in the queue after two insertions is:" << MyPQ->PQLength() << endl; // length: 2
